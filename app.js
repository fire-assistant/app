...
(function initDevLetter() {
  ...
  const LETTER_TEXT = `작년, 한 건물의 화재안전조사를 나가던 길이었습니다. '이 건물엔 이런 시설이 있어야겠지' 머릿속으로 그려보며 들어섰지만, 막상 현장은 제 예상과 사뭇 달랐습니다. 있어야 할 시설이 빠져 있기도, 없어도 될 시설이 들어와 있기도 했지요. 그때 문득 생각했습니다 — 건물의 규모와 허가일자 등 필요한 정보만 넣으면 그 건물에 필요한 소방시설이 한눈에 정리되어 나오는 도구가 있다면 어떨까. 이 작은 바람 하나가 시작이었습니다.

[개발자가 전하는 글]
1. 막연한 생각을 도구로
그 막연한 바람을 현실로 옮기는 일은 생각보다 더디고 먼 길이었습니다. 처음에는 AI라면 충분히 가능하리라 믿고, 오랫동안 ChatGPT·Gemini·Claude까지 붙들고 시도했습니다. 하지만 돌아오는 건 번번이 어긋난 답뿐이었습니다. 그래서 결국, 수고스럽더라도 직접 만들어 보기로 했습니다. 대단한 기술이 있어서가 아니라, 그저 한발 먼저 시도해봤을 뿐입니다. 건축물은 갈수록 대형화되고 화재 양상도 복잡해지는데, 정작 필요한 시설을 빠르게 파악할 도구는 마땅치 않았으니까요.

2. 만든 사람 이야기
솔직히 말씀드리면, 저는 화려한 자격증을 가진 기술사도, 예방 부서에서 오래 근무한 베테랑도 아닙니다. 그저 안전센터에서 근무하며, 예방 업무가 재미있어 자연스레 조금 더 들여다보게 된 대원일 뿐입니다. 하지만 그래서 오히려, 전문가의 답이 아니라 같은 자리에서 똑같이 헤맸던 사람의 눈높이로 이 앱을 만들 수 있었다고 생각합니다. 법전 구석의 어려운 조문보다, 현장에서 가장 자주 손이 가는 기능부터 담으려 한 이유입니다. 만드는 내내 모르는 부분은 자료를 찾고 선배님께 여쭤가며, 저 역시 예방 업무를 더 깊이 배울 수 있었습니다.

3. 누구를 위해, 무엇을 연습하나
특히 예방 업무를 처음 맡거나 소방시설이 아직 생소한 분들을 떠올리며 만들었습니다. 예방 업무는 결국 각자 현장에서 부딪히며 익혀 나가야 하는데, 곁에서 차근히 일러줄 선배가 늘 있는 것도 아니어서 막막함을 느끼는 분이 적지 않습니다. 이 앱은 그 빈틈을 메우는 작은 보조 도구입니다. 시간과 장소에 구애받지 않고, 건물의 규모와 용도를 보며 어떤 시설이 설치될지 미리 그려보는 연습을 반복할 수 있도록 만들었습니다.

4. 어떤 도구이고, 어디까지 믿어도 되나
가장 중심이 되는 기능은 '소방시설 탐색기'입니다. 코딩에도 자료 조사에도 가장 오랜 시간과 공을 들인 기능으로, 건물의 규모와 용도를 입력하면 설치 대상 소방시설을 정리해 보여줍니다. 여기에 서류 마감일을 놓쳐 과태료와 씨름하는 일이 없도록 돕는 법정기한 계산기를 더했고, 그 밖에 실무에서 자주 쓰이는 기능과 설명을 함께 담았습니다. 다만 분명히 말씀드릴 것이 있습니다. 이 도구가 모든 건물을 100% 맞히지는 못합니다. 실제로 화재안전조사를 나가 보면 있어야 할 시설이 없거나, 없어도 될 시설이 설치된 경우가 적지 않았습니다. 면제 조건으로 빠지거나 관계인이 자진 설치하는 등 건물마다 사정이 다르기 때문입니다. 그래서 현장에서 마주한 여러 예외 조건을 최대한 반영하되, 입력은 간단하게 결과는 실제에 가깝게 나오도록 편의성과 정확성 사이를 끊임없이 저울질하며 다듬었습니다. 참고를 위한 길잡이로 활용하시고, 최종 판단은 늘 법령과 함께 확인해 주시길 부탁드립니다.

5. 배포를 앞두고, 그리고 부탁
출동과 업무를 마친 시간, 그리고 비번 날 하루 몇 시간씩을 모아 만든 결과물입니다. 다 만들고 나서도 '괜히 나선다고 여겨지지 않을까' 하는 걱정에 메일 한 통을 보내기까지 오래 망설였습니다. 그럼에도 용기를 낸 건, 그동안 소방에서 일하며 받은 많은 가르침과 도움에 작게나마 보답하고 싶었기 때문입니다. 모든 분의 필요를 완벽히 채우긴 어렵겠지만, 버그 제보나 기능 제안, 법적 오류 같은 의견은 언제나 감사히 검토하겠습니다. 지금의 모습에도 이미 여러 동료의 아이디어가 담겨 있습니다. 나쁜 의도가 아닌, 현장 동료들을 향한 진심으로 시작한 일인 만큼 너그럽게 봐주시고 따뜻한 응원 부탁드립니다.`;
