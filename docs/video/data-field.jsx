...
const COLUMN_TOKENS = [
  ...
  // 2 — 보고서 읽는법
  ['P.1', 'P.4', 'P.8', '별표 4', '제5조', '표지', '점검표', '대상물', '✓', '✕', '결과', '스프링클러', '수조', '항목', '제출'],
  // 3 — 소방시설 설명
  ['옥내소화전', '자탐', '비상방송설비', '구성', '기준', '소화기', '경보기', '비상조명', 'kW', 'L/min', 'Ø50', 'SPEC', 'Hz', 'φ', '소방서장'],
  // 4 — 작동·종합
  ['작동', '종합', '5,000㎡', '11F↑', '대상', 'INSP', 'OP', 'TOTAL', '연1회', '반기', 'SP설치', 'AUTO', 'COMP', '특정', '판정'],
  // 5 — 다중이용업소
  ['노래연습장', 'PC방', '고시원', '음식점', '150㎡', '2층↑', '복층', '영업장', 'KARA', 'NET', 'F&B', 'MUL', '판정', '안전', 'M.U.'],
  // 6 — 수용인원
  ['1.9㎡/人', '300人', '강의실', '숙박', '판매', '식당', '바닥면적', '수용', 'OCC', 'CAP', '÷1.9', '×0.5', '인', 'CALC', '名'],
];
